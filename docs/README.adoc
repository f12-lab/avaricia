...
image::assets/in-band/error-based/Recon1.png[Reconocimiento1,width=420,align=center]

image::assets/in-band/error-based/Recon2.png[Reconocimiento2,width=640,align=center]

===== Payloads

Para cada uno de ellos utilizaremos la cláusula updatexml(), que permite modificar datos XML dentro de bases de datos MySQL. En nuestro caso lo usaremos para lanzar los errores y mostrar su contenido como un mensaje.
...
image::assets/in-band/error-based/Version1.png[Version1,width=500,align=center]

image::assets/in-band/error-based/Version2.png[Version2,width=640,align=center]
...
image::assets/in-band/error-based/BaseDatos1.png[BaseDatos1,width=620,align=center]

image::assets/in-band/error-based/BaseDatos2.png[BaseDatos2,width=620,align=center]
...
Como ya sabemos la tabla y podemos conocer las distintas columnas que tiene, se hace más sencilla la búsqueda de información. En este caso, vamos a extraer el nombre del primer usuario.
...
* *group_concat(table_name)* -> Esta función de MySQL concatena todos los nombres de las tablas en la base de datos, obteniéndolas separadas por comas.
...
En nuestro caso, vamos a usar AND ya que con los anteriores resultados sabemos que existe el usuario *admin* y *user*. En caso de que no conozcamos estos datos se recomienda usar OR.
...
image::assets/blind/boolean-based/Recon1.png[Reconocimiento1,width=470,align=center]

image::assets/blind/boolean-based/Recon2.png[Reconocimiento2,width=470,align=center]
...
image::assets/blind/boolean-based/Recon3.png[Reconocimiento3,width=460,align=center]

image::assets/blind/boolean-based/Recon4.png[Reconocimiento4,width=460,align=center]
...
* *= 'a'* -> Compara si ese carácter es 'a'.
...
image::assets/blind/boolean-based/BaseDatos1.png[BaseDatos1,width=440,align=center]

image::assets/blind/boolean-based/BaseDatos2.png[BaseDatos2,width=440,align=center]
...
image::assets/blind/boolean-based/BaseDatos3.png[BaseDatos3,width=440,align=center]

image::assets/blind/boolean-based/BaseDatos4.png[BaseDatos4,width=440,align=center]
...
image::assets/blind/boolean-based/Tablas1.png[Tablas1,width=440,align=center]

image::assets/blind/boolean-based/Tablas2.png[Tablas2,width=440,align=center]
...
image::assets/blind/boolean-based/Tablas3.png[Tablas3,width=440,align=center]

image::assets/blind/boolean-based/Tablas4.png[Tablas4,width=440,align=center]
...
image::assets/blind/boolean-based/Columnas1.png[Columnas1,width=420,align=center]

image::assets/blind/boolean-based/Columnas2.png[Columnas2,width=440,align=center]

Y al igual que el resto se debe de ir carácter por carácter para obtener la palabra correcta. Se van cambiando posiciones (LIMIT 1,1, LIMIT 2,1, etc.) y posiciones del carácter (SUBSTRING(...,2,1), etc.) para inferir cada tabla y cada letra.
...
image::assets/blind/boolean-based/Contraseña1.png[Contraseña1,width=440,align=center]

image::assets/blind/boolean-based/Contraseña2.png[Contraseña2,width=440,align=center]
...
image::assets/blind/boolean-based/Contraseña3.png[Contraseña3,width=440,align=center]

image::assets/blind/boolean-based/Contraseña4.png[Contraseña4,width=440,align=center]
...
image::assets/blind/time/Recon1.png[Reconocimiento1,width=440,align=center]

image::assets/blind/time/Recon2.png[Reconocimiento2,width=540,align=center]
...
image::assets/blind/time/Recon3.png[Reconocimiento3,width=440,align=center]

image::assets/blind/time/Recon4.png[Reconocimiento4,width=440,align=center]
...
image::assets/blind/time/BaseDatos1.png[BaseDatos1,width=420,align=center]

image::assets/blind/time/BaseDatos2.png[BaseDatos2,width=540,align=center]
...
image::assets/blind/time/Tablas1.png[Tablas1,width=480,align=center]

image::assets/blind/time/Tablas2.png[Tablas2,width=540,align=center]
...
image::assets/blind/time/Columnas1.png[Columnas1,width=500,align=center]

image::assets/blind/time/Columnas2.png[Columnas2,width=420,align=center]
...
En este caso vamos a buscar la contraseña *admin123* dentro de la columna *password*
...
image::assets/blind/time/Contraseña1.png[Contraseña1,width=400,align=center]

image::assets/blind/time/Contraseña2.png[Contraseña2,width=420,align=center]
...
image::assets/oob/OOB.png[OOB,width=340,align=center]
